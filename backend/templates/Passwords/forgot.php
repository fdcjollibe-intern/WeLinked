                ...
                <div class="login-page">
                    <div class="form-flipper">
                        <div class="login-content">
                            ...
                            <form id="forgotForm" class="login-form" method="post" action="<?= $this->Url->build(['controller' => 'Passwords', 'action' => 'forgot']) ?>">
...
<!-- Form submits to server; no frontend routing required. -->
