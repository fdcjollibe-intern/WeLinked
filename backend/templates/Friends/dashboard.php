<?php
/**
 * Friends Page - Dashboard Layout
 * Shows friends list in the middle column with full dashboard layout
 */
?>
...
<div class="bg-gray-50 min-h-screen pt-20">
    <div class="max-w-screen-2xl mx-auto flex">
        ...
        <!-- Center Content Area - Friends List -->
        <main id="middle-component" class="flex-1 min-w-0 px-4 lg:px-8">
            <?= $this->element('Friends/friends_list', ['following' => $following, 'followers' => $followers]) ?>
        </main>
